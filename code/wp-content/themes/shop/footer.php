<footer>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="box-footer info-contact">
                    ...
                    <div class="content-contact">
                        ...
                        <p>
                            <strong>Địa chỉ:</strong> 448/67 Trưng Nữ Vương, Hải Châu, Đà Nẵng
                        </p>
                        <p>
                            <strong>Email: </strong> huyhuynh@gmail.com
                        </p>
                        <p>
                ...
                <div class="box-footer info-contact">
                    ...
                    <div class="content-list">
                        <?php wp_nav_menu([
                            ...
                            'container' => 'false',
                            'menu_id' => 'header-footer',
                            'menu-class' => 'header-footer'
                        ])
                        ?>
                    </div>
                </div>
    ...
    <div class="copyright">
        <p>Copyright © 2023 HKSHOP All Rights Reserved - Design by THIETKEWEB43.COM</p>
    </div>
</footer>
</div>
